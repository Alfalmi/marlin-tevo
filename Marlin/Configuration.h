...
#define PRINTER_NAME "Taranchura"  // Change this to whatever you wish, or leave it as it is.
 ...
 */
#define E0_STEPS      407 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
 ...
 */
#define Z_STEPS      541  //1600  Stock lead screw
...
#define STRING_CONFIG_H_AUTHOR "(floydp)" // Who made the changes.
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 81, 81, Z_STEPS, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 81, 81, Z_STEPS, E0_STEPS }
#endif
